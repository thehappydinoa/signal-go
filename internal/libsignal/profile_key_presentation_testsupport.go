...
func cProfileKeyCredentialRequestIn(b *[ProfileKeyCredentialRequestLen]byte) *C.SignalType_FixedArray329_uint8_t {
...
func cProfileKeyCommitmentIn(b *[profileKeyCommitmentLen]byte) *C.SignalType_FixedArray97_uint8_t {
	return (*C.SignalType_FixedArray97_uint8_t)(unsafe.Pointer(b))
}
