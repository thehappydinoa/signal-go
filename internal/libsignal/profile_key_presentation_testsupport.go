...
func cProfileKeyCredentialRequestIn(b *[ProfileKeyCredentialRequestLen]byte) *[329]C.uchar {
	return (*[329]C.uchar)(unsafe.Pointer(b))
}
...
func cProfileKeyCommitmentIn(b *[profileKeyCommitmentLen]byte) *[97]C.uchar {
