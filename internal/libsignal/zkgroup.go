...
func cGroupMasterKeyIn(b []byte) *C.SignalType_FixedArray32_uint8_t {
...
func cGroupSecretParamsIn(b *[GroupSecretParamsLen]byte) *C.SignalType_FixedArray289_uint8_t {
...
func cGroupPublicParamsIn(b *[GroupPublicParamsLen]byte) *C.SignalType_FixedArray97_uint8_t {
	return (*C.SignalType_FixedArray97_uint8_t)(unsafe.Pointer(b))
}
...
func cUUIDCiphertextIn(b []byte) *C.SignalType_FixedArray65_uint8_t {
	return (*C.SignalType_FixedArray65_uint8_t)(unsafe.Pointer(&b[0]))
}
...
func cRandomnessIn(b *[ZKRandomnessLen]byte) *C.SignalType_FixedArray32_uint8_t {
	return (*C.SignalType_FixedArray32_uint8_t)(unsafe.Pointer(b))
}
