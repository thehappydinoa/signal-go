...
func TestLinkDeviceValidatesInputs(t *testing.T) {
	...
	if _, err := c.LinkDevice(context.Background(), "+1", "", LinkDeviceRequest{VerificationCode: "code"}); err == nil {
		t.Error("expected error empty password")
	}
	if _, err := c.LinkDevice(context.Background(), "+1", "pw", LinkDeviceRequest{}); err == nil {
